    ...
    public class Mundo : GameWindow
    {
      ...
      objetoSelecionado = new SplineInter(mundo, ref rotuloAtual);
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if(estadoTeclado.IsKeyPressed(Keys.Q) && objetoSelecionado.GetType() == typeof(SrPalito))
            {
                SrPalito palito = objetoSelecionado as SrPalito;
                palito.AtualizarPe(-0.1);
            }
            if (estadoTeclado.IsKeyPressed(Keys.W) && objetoSelecionado.GetType() == typeof(SrPalito))
            {
                SrPalito palito = objetoSelecionado as SrPalito;
                palito.AtualizarPe(0.1);
            }
            if (estadoTeclado.IsKeyPressed(Keys.A) && objetoSelecionado.GetType() == typeof(SrPalito))
            {
                SrPalito palito = objetoSelecionado as SrPalito;
                palito.AtualizarRaio(-0.1);
            }
            if (estadoTeclado.IsKeyPressed(Keys.S) && objetoSelecionado.GetType() == typeof(SrPalito))
            {
                SrPalito palito = objetoSelecionado as SrPalito;
                palito.AtualizarRaio(0.1);
            }
            if (estadoTeclado.IsKeyPressed(Keys.Z) && objetoSelecionado.GetType() == typeof(SrPalito))
            {
                SrPalito palito = objetoSelecionado as SrPalito;
                palito.AtualizarAngulo(-15);
            }
            if (estadoTeclado.IsKeyPressed(Keys.X) && objetoSelecionado.GetType() == typeof(SrPalito))
            {
                SrPalito palito = objetoSelecionado as SrPalito;
                palito.AtualizarAngulo(15);
            }
